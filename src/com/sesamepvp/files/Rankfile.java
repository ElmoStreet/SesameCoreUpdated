...
public class Rankfile {
	static Rankfile instance = new Rankfile();
	Plugin p;
	...
	public static Rankfile getInstance() {
		return instance;
	}
//commit 2
	public void setup(Plugin p) {
		...
		dfile = new File(p.getDataFolder(), "rankdata.yml");
		if (!dfile.exists()) {
			try {
				dfile.createNewFile();
			} catch (IOException e) {
				Bukkit.getServer().getLogger()
						.severe(ChatColor.RED + "Could not create rkdata.yml!");
			}
		}
